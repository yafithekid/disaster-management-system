    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li><a href="/map/disaster_event">Disaster</a></li>
                <li><a href="/map/med_fac">MedFacs</a></li>
                <li><a href="/map/ref_camps">RefCamps</a></li>
                <li><a href="/map/victim_mov">Victim Movement</a></li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
    </div>
